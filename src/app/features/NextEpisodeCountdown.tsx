    ...
    <div className="absolute inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="flex flex-col items-center gap-6 text-center">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={onCancel}
            className="cursor-pointer px-4 py-2 text-sm font-medium text-foreground/70 hover:text-foreground transition-colors"
          >
            Cancel
          </button>
          <button
            onClick={onPlayNow}
            className="cursor-pointer px-4 py-2 text-sm font-medium bg-red-500 text-white rounded-md hover:bg-red-500/70 transition-colors"
          >
            Play Now
          </button>
        </div>
